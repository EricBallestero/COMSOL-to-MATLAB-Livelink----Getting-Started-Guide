function [out] = Comsol_TubeSlit()
% Comsol_TubeSlit.m
% Model exported on Aug 1 2022, 12:10 by COMSOL 5.3.1.275.
%-------------------------------------------------------------------------%
%% CALL COMSOL
disp(' -- Call COMSOL')
%-------------------------------------------------------------------------%
...
model.component('comp1').geom('geom1').feature('r1').set('pos', {'-L/12' '0'});
model.component('comp1').geom('geom1').feature('r1').set('base', 'center');
model.component('comp1').geom('geom1').feature('r1').set('size', {'L/6' 'H'});
% creates a rectangle 'r2' in the 'geom1' object with label, position, base and size
model.component('comp1').geom('geom1').create('r2', 'Rectangle');
model.component('comp1').geom('geom1').feature('r2').label('Tube');
...
model.component('comp1').geom('geom1').feature('r3').label('Slit');
model.component('comp1').geom('geom1').feature('r3').set('pos', {'L+l_s/2' '0'});
model.component('comp1').geom('geom1').feature('r3').set('base', 'center');
model.component('comp1').geom('geom1').feature('r3').set('size', {'l_s' 'H'});
...
kk = input('Is the geometry valid?');
%-------------------------------------------------------------------------%
%% PML
disp(' -- Set PML')
%-------------------------------------------------------------------------%
...
disp(' -- Probe creation')
%-------------------------------------------------------------------------%
% creates a domain point probe 'pdom1' at an [x,y] location
model.component('comp1').probe.create('pdom1', 'DomainPoint');
model.component('comp1').probe('pdom1').set('coords2', {'L' '0'});
% sets expression to evaluate, here scattered field 'acpr.p_s'
...
disp(' -- Save model')
%-------------------------------------------------------------------------%
mphsave(model,'./Comsol_TubeSlit.mph');
out = model;
disp(' -- DONE')
end
